...
public class PlanillaTrabajoCumplimientoReliquidacionServicioSheetExcel extends ExcelTemplate<ValorizarReliquidacionSummaryVO> {
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;

	public PlanillaTrabajoCumplimientoReliquidacionServicioSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ValorizarReliquidacionSummaryVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public PlanillaTrabajoCumplimientoReliquidacionServicioSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ValorizarReliquidacionSummaryVO> items, Integer offsetRows, Integer offsetColumns) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;	
	}
