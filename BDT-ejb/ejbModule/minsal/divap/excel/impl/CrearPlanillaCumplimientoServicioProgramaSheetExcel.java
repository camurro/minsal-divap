...
public class CrearPlanillaCumplimientoServicioProgramaSheetExcel extends ExcelTemplate<CumplimientoApsMunicipalProgramaVO> {
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;

	public CrearPlanillaCumplimientoServicioProgramaSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<CumplimientoApsMunicipalProgramaVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public CrearPlanillaCumplimientoServicioProgramaSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<CumplimientoApsMunicipalProgramaVO> items, Integer offsetRows, Integer offsetColumns) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;	
	}
