...
public class ProgramaAPSMunicipalesSheetExcel extends ExcelTemplate<ProgramaAPSVO>{
	...
	public ProgramaAPSMunicipalesSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public ProgramaAPSMunicipalesSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items, Integer offsetRows, Integer offsetColumns){
