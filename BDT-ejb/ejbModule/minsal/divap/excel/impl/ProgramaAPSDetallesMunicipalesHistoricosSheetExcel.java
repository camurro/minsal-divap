...
public class ProgramaAPSDetallesMunicipalesHistoricosSheetExcel extends ExcelTemplate<ProgramaAPSVO>{
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;
	public ProgramaAPSDetallesMunicipalesHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public ProgramaAPSDetallesMunicipalesHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items, Integer offsetRows, Integer offsetColumns){
