...
public class ProgramaAPSDetallesServiciosHistoricosSheetExcel extends ExcelTemplate<ProgramaAPSServicioResumenVO>{
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;
	public ProgramaAPSDetallesServiciosHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSServicioResumenVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public ProgramaAPSDetallesServiciosHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSServicioResumenVO> items, Integer offsetRows, Integer offsetColumns){
