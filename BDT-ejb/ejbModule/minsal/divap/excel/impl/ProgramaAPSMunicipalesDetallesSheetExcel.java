...
public class ProgramaAPSMunicipalesDetallesSheetExcel extends ExcelTemplate<ProgramaAPSVO>{
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;
	public ProgramaAPSMunicipalesDetallesSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public ProgramaAPSMunicipalesDetallesSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items, Integer offsetRows, Integer offsetColumns){
