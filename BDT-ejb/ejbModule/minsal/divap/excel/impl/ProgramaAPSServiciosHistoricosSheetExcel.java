...
public class ProgramaAPSServiciosHistoricosSheetExcel extends ExcelTemplate<ProgramaAPSServicioResumenVO>{
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;
	public ProgramaAPSServiciosHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSServicioResumenVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public ProgramaAPSServiciosHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSServicioResumenVO> items, Integer offsetRows, Integer offsetColumns){
