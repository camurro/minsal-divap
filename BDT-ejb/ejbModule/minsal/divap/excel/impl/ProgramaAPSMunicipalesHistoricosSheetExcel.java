...
public class ProgramaAPSMunicipalesHistoricosSheetExcel extends ExcelTemplate<ProgramaAPSVO>{
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;
	public ProgramaAPSMunicipalesHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public ProgramaAPSMunicipalesHistoricosSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ProgramaAPSVO> items, Integer offsetRows, Integer offsetColumns){
