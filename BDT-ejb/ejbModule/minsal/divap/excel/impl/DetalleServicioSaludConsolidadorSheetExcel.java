...
public class DetalleServicioSaludConsolidadorSheetExcel extends ExcelTemplate<ResumenConsolidadorVO>{
	private List<CellExcelVO> headerComplex = null;
	private List<CellExcelVO> subHeadeComplex = null;
	
	public DetalleServicioSaludConsolidadorSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ResumenConsolidadorVO> items) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;
	}
	
	public DetalleServicioSaludConsolidadorSheetExcel(List<CellExcelVO> header, List<CellExcelVO> subHeader, List<ResumenConsolidadorVO> items, Integer offsetRows, Integer offsetColumns) {
		super(null, items);
		headerComplex = header;
		subHeadeComplex = subHeader;	
	}
