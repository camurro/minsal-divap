...
public enum TipoDocumentosProcesos{
	PLANTILLAASIGNACIONDESEMPENODIFICIL(1, "Plantilla Asignación de Desempeño Difícil"), 
	...
	PLANTILLARESOLUCIONAPORTEESTATALUR(9,"Plantilla Resoluciones Comunales de Aporte Estatal UR"), 
	PLANTILLARESOLUCIONAPORTEESTATALCF(10,"Plantilla Resoluciones Comunales de Aporte Estatal CF"),
	RESOLUCIONAPORTEESTATALUR(11,"Resoluciones Comunales de Aporte Estatal UR"), 
	RESOLUCIONAPORTEESTATALCF(12,"Resoluciones Comunales de Aporte Estatal CF"),
	PLANTILLABORRADORAPORTEESTATAL(13,"Plantilla Borrador decreto aporte estatal"), 
	ASIGNACIONDESEMPENODIFICIL(14, "Asignación de Desempeño Difícil"),
	PLANILLAOFICIOCONSULTA(20, "Planilla Oficio Consulta"), 
	TOMARAZONAPORTEESTATAL(21, "Toma Razón Decreto Aporte Estatal"), 
	PLANILLABORRADORAPORTEESTATAL(22, "Planilla Oficio Consulta"),
	PLANTILLABASECUMPLIMIENTOMUNICIPAL(59,"Plantilla Base Cumplimiento Municipal"), 
	PLANTILLABASECUMPLIMIENTOSERVICIO(60,"Plantilla Base Cumplimiento Servicio"),
	...
	PLANTILLARESOLUCIONPROGRAMASAPS(82,"Plantilla Resolución Recursos Programa"),
	...
	BASECUMPLIMIENTO(50, "Base Cumplimiento"), 
	PLANTILLARESOLUCIONREBAJA(51,"Plantilla Resolución Rebaja Aporte Estatal"), 
	RESOLUCIONREBAJA(52,"Resolución Rebaja Aporte Estatal"),
	PLANTILLACORREORESOLUCIONSERVICIOSALUDREBAJA(53,"Plantilla Correo Resoluciones Servicios de Salud - Rebaja"), 
	PLANTILLACORREOCONSULTAREGIONALPERCAPITA(54,"Plantilla Correo Consulta Regional - percapita"),
	PLANTILLACORREORESOLUCIONESPERCAPITA(55,"Plantilla Correo Resoluciones - percapita"), 
	PLANTILLAOFICIOPROGRAMACIONCAJA(56,"Plantilla Oficio Programación Caja"),
	
	CONVENIOS(50,"Convenios Documentos"), 
	PLANILLABASECUMPLIMIENTOMUNICIPAL(59,"Planilla Base Cumplimiento Municipal"), 
	PLANILLABASECUMPLIMIENTOSERVICIO(60,"Planilla Base Cumplimiento Servicio"),
	PLANTILLACORREORESOLUCIONRETIRO(65,"Plantilla Correo Resolucion Retiro"),
	ADJUNTOSEGUIMIENTORESOLUCIONRETIRO(150, "Documento Adjunto Seguimiento Resolución Retiro"), 
	RESOLUCIONRETIRO(151, "Resolución Retiro"), 
	PLANTILLARESOLUCIONRETIRO(152, "Plantilla Resolución Retiro"),
	REPORTEPOBLACIONPERCAPITA(100,"Reporte Poblacion Per Capita"), 
	REPORTEREBAJA(101,"Reporte Rebaja"), 
	REPORTEGLOSA07(102,"Reporte Glosa 07"),
	REPORTEMARCOPRESPUESTARIOCOMUNA(103,"Reporte Marco Presupuestario Comuna"), 
	REPORTEMARCOPRESPUESTARIOSERVICIO(104,"Reporte Marco Presupuestario Servicio"), 
	REPORTEHISTORICOPROGRAMACOMUNA(105,"Reporte Historico Por Programa - Comuna"), 
	REPORTEHISTORICOPROGRAMAESTABLECIMIENTO(106,"Reporte Historico Por Programa - Establecimiento"),
	REPORTEMONITOREOPROGRAMACOMUNA(107,"Reporte Monitoreo Programa - Comuna"), 
	REPORTEMONITOREOPROGRAMASERVICIO(108,"Reporte Monitoreo Programa - Servicios"),
	REPORTEESTADOSITUACIONPROGRAMABYCOMUNA(109,"Reporte Estado Situacion Programa - Comuna"), 
	REPORTEESTADOSITUACIONPROGRAMABYSERVICIO(110,"Reporte Estado Situacion Programa - Servicio"),
	REPORTEMETADESEMPENOCUADRO1(111,"Reporte Meta Desempeno - Cuadro1"), 
	REPORTEMETADESEMPENOCUADRO2(112,"Reporte Meta Desempeno - Cuadro2"),
	CONVENIOSERVICIO(153, "Convenio Servicio"), CONVENIOCOMUNA(154, "Convenio Comuna"), 
	PLANILLACONVENIOMUNICIPAL(155, "Planilla Convenio Municipal"), 
	PLANILLACONVENIOSERVICIO(156, "Planilla Convenio Servicio"),
	PLANTILLAORDINARIOSOLICITUDANTECEDENTES(159, "Ordinario Solicitud Antecedentes"), 
	ORDINARIOSOLICITUDANTECEDENTES(160, "Ordinario Solicitud Antecedentes"),
	PLANTILLACORREOORDINARIOSOLICITUDANTECEDENTES(161, "Plantilla Correo Ordinario Solicitud Antecedentes"), 
	PLANTILLAMODIFICACIONRESOLUCIONAPORTEESTATAL(170, "Plantilla ordinario modificación aporte estatal"),
	ORDINARIOMODIFICACIONRESOLUCIONAPORTEESTATAL(171, "Ordinario modificación aporte estatal"), 
	PLANTILLAMODIFICACIONDECRETOAPORTEESTATAL(172, "Plantilla modificación decreto aporte estatal"),
	
	PLANTILLACORREOORDINARIOPLANILLA(175, "Plantilla Correo Ordinario y Planilla"),
	ORDINARIOPROGRAMACIONCAJA(176, "Ordinario Programación Caja"), 
