...
public class ProgramasService {
	...
	public List<ResumenProgramaServiciosVO> getResumenServicio(Integer idProgramaAno, Integer id){
		...
		for(ComponentesVO compo : componentes){
			for(SubtituloVO sub : compo.getSubtitulos()){
				...
				if(!Subtitulo.SUBTITULO24.getId().equals(sub.getId())){
	...
	public Integer evaluarAnoSiguiente(Integer programaSeleccionado, Integer ano) {
		...
		ProgramaVO programa = getProgramaByIdProgramaAndAno(programaSeleccionado, ano);
	...
	public Integer getProgramaAnoSiguiente(Integer idPrograma, Integer anoSiguiente) {
