...
public class AlfrescoService {
	...
	private String getTicket() throws IOException {
		String alfrescoTiccketURL = alfrescoServer + "/login?u=" + alfrescoUsername + "&pw=" + alfrescoPassword;
	...
	public void delete(String docAlfresco) {
		try {
			String authTicket = getTicket();
			String urlString = alfrescoServer + "/archive/workspace/SpacesStore/" + docAlfresco + "?alf_ticket="
					+ authTicket;
