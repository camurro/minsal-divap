...
public class OTService {
	...
	public List<OTResumenMunicipalVO> getDetalleOTMunicipalConsolidador(Integer componenteSeleccionado,
		...
		for(DetalleRemesas remesaMes : remesasMesActual){
			...
			ProgramaVO programaVO = programasService.getProgramaAno(idProgramaAno);
			remesas = getRemesasPrograma(programaVO.getId(), Integer.parseInt(getMesCurso(true)), programaVO.getAno());
	...
	public List<RemesasProgramaVO> getRemesasPerCapita(Integer idPrograma, Integer idMes, Integer ano) throws ParseException {
		List<ProgramaFechaRemesa> fechasRemesas = programasDAO.findRemesasByPrograma(idPrograma);
		List<RemesasProgramaVO> remesasVO = new ArrayList<RemesasProgramaVO>();
		ano = ((ano == null) ? getAnoCurso() : ano);
		for (int i = 0; i < 1; i++) {
	...
	public List<OTPerCapitaVO> getDetallePerCapita(
		...
		for(DetalleRemesas remesaMes : remesasMesActual){
			...
			try {
				...
				remesas = getRemesasPerCapita(programaVO.getId(), Integer.parseInt(getMesCurso(true)), programaVO.getAno());
