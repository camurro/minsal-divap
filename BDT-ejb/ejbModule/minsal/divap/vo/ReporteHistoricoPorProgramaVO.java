...
public class ReporteHistoricoPorProgramaVO implements Serializable{
	...
	public ReporteHistoricoPorProgramaVO(){
		
	}
	public ReporteHistoricoPorProgramaVO(String region, String servicio, String comuna, Long marco2006, Long marco2007, Long marco2008, Long marco2009, Long marco2010, Long marco2011, Long marco2012, Long marco2013, Long marco2014){
		super();
		this.region = region;
	...
	public String toString() {
		return "ReporteHistoricoPorProgramaVO [region=" + region
				+ ", servicio=" + servicio + ", comuna=" + comuna
				+ ", marco2006=" + marco2006 + ", marco2007=" + marco2007
				+ ", marco2008=" + marco2008 + ", marco2009=" + marco2009
				+ ", marco2010=" + marco2010 + ", marco2011=" + marco2011
				+ ", marco2012=" + marco2012 + ", marco2013=" + marco2013
				+ ", marco2014=" + marco2014 + "]";
	}
