...
@NamedQueries({
    ...
    @NamedQuery(name = "DocumentoModificacionPercapita.findByIdModificacionPercapitaTiposNotFinal", query = "SELECT d FROM DocumentoModificacionPercapita d WHERE d.modificacionPercapita.idModificacionDistribucionInicialPercapita = :idModificacionDistribucionInicialPercapita and d.tipoDocumento.idTipoDocumento IN (:idTiposDocumento) and d.documento.documentoFinal = false"),
    @NamedQuery(name = "DocumentoModificacionPercapita.deleteUsingIds", query = "DELETE FROM DocumentoModificacionPercapita d WHERE d.idDocumentoModificacionPercapita IN (:idDocumentosModificacionPercapita)"),
    @NamedQuery(name = "DocumentoModificacionPercapita.findByServicioModificacionPercapitaTypes", query = "SELECT d.documento FROM DocumentoModificacionPercapita d WHERE d.modificacionPercapita.idModificacionDistribucionInicialPercapita = :idModificacionPercapita and d.servicio.id = :idServicio and d.tipoDocumento.idTipoDocumento IN (:idTiposDocumento) and d.documento.documentoFinal = true order by d.documento.fechaCreacion desc"),
    @NamedQuery(name = "DocumentoModificacionPercapita.findVersionFinalByIdModificacionPercapitaIdServicioTipoDocumento", query = "SELECT d.documento FROM DocumentoModificacionPercapita d WHERE d.modificacionPercapita.idModificacionDistribucionInicialPercapita = :idModificacionDistribucionInicialPercapita and d.servicio.id = :idServicio and d.tipoDocumento.idTipoDocumento = :idTipoDocumento and d.documento.documentoFinal = true order by d.documento.fechaCreacion desc")})
