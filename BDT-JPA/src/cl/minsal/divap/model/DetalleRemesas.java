...
@NamedQueries({
    ...
    @NamedQuery(name = "DetalleRemesas.getRemesasPagadasComuna", query = "SELECT d FROM DetalleRemesas d WHERE d.programaAno.idProgramaAno = :idProgramaAno and d.comuna.id = :idComuna and d.subtitulo.idTipoSubtitulo = :idTipoSubtitulo and d.remesaPagada = :remesaPagada"),
    ...
    @NamedQuery(name = "DetalleRemesas.groupMontoRemesaNoPagadasProgramaSubtituloComuna", query = "SELECT d.comuna.id, SUM(d.montoRemesa) FROM DetalleRemesas d WHERE d.programaAno.idProgramaAno = :idProgramaAno and d.subtitulo.idTipoSubtitulo = :idSubtitulo and d.comuna.id = :idComuna and d.mes.idMes <= :mes and d.remesaPagada = false GROUP BY d.comuna.id"),
