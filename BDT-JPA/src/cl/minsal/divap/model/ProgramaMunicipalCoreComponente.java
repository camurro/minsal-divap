...
@NamedQueries({
    ...
    @NamedQuery(name = "ProgramaMunicipalCoreComponente.findByServicioComponente", query = "SELECT p FROM ProgramaMunicipalCoreComponente p WHERE p.municipalCoreComponente.id = :idComponente and p.programaMunicipalCore.comuna.servicioSalud.id = :idServicio"),
