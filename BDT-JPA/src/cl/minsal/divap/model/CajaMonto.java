...
@NamedQueries({
	...
	@NamedQuery(name = "CajaMonto.findByServicioProgramaComponenteSubtituloMes", query = "SELECT c FROM CajaMonto c WHERE c.caja.servicio.id = :idServicio and c.caja.programa.idProgramaAno = :idProgramaAno and c.caja.idComponente.id = :idComponente and c.caja.idSubtitulo.idTipoSubtitulo = :idSubtitulo and c.cajaMontoPK.mes = :mes"),
