...
public class EstimacionFlujoCajaRESTService extends BaseRest {
	...
	@Produces("application/json")
	public Integer eliminarPlanillaPropuesta(
			@PathParam("idLineaProgramatica") Integer idLineaProgramatica) {
		System.out.println("[Eliminar Planilla] -->" + idLineaProgramatica);
		// EstimacionFlujoCajaService estimacionFlujoCajaService =
		// getService(EstimacionFlujoCajaService.class);
	...
	public Integer elaborarOrdinarioProgramacion(
		...
		estimacionFlujoCajaService
				.elaborarOrdinarioProgramacionCaja(idLineaProgramatica);
		// Generar la Planilla Propuesta
		estimacionFlujoCajaService
				.generarPlanillaPropuesta(idLineaProgramatica);
		return 1;
	}
