...
@Named
public class ProgramasReforzamientoSeguimientoConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof ProgramasReforzamientoSeguimiento) {
            ProgramasReforzamientoSeguimiento o = (ProgramasReforzamientoSeguimiento) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), ProgramasReforzamientoSeguimiento.class.getName()});
            return null;
        }
    }
