...
@Named
public class ReporteEmailsAdjuntosConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof ReporteEmailsAdjuntos) {
            ReporteEmailsAdjuntos o = (ReporteEmailsAdjuntos) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), ReporteEmailsAdjuntos.class.getName()});
            return null;
        }
    }
