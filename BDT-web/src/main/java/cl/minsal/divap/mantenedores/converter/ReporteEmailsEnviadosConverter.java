...
@Named
public class ReporteEmailsEnviadosConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof ReporteEmailsEnviados) {
            ReporteEmailsEnviados o = (ReporteEmailsEnviados) object;
            return getStringKey(o.getId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), ReporteEmailsEnviados.class.getName()});
            return null;
        }
    }
