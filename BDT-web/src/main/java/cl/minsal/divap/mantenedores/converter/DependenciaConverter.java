...
public class DependenciaConverter implements Converter {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof Dependencia) {
            ...
            return getStringKey(o.getIdDependenciaPrograma());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), Dependencia.class.getName()});
            return null;
        }
    }
