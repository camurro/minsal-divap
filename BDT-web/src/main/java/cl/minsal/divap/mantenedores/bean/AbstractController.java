...
import cl.minsal.divap.mantenedores.facade.AbstractFacade;
...
public abstract class AbstractController<T> implements Serializable {
    ...
    public void save(ActionEvent event) {
        String msg = ResourceBundle.getBundle("bundle/Bundle").getString(itemClass.getSimpleName() + "Updated");
    ...
    public void saveNew(ActionEvent event) {
        ...
        String msg = ResourceBundle.getBundle("bundle/Bundle").getString(itemClass.getSimpleName() + "Created");
    ...
    public void edit(ActionEvent event){
    	System.out.println("entra al medoto edit");
    	String msg = ResourceBundle.getBundle("bundle/Bundle").getString(itemClass.getSimpleName() + "Updated");
    	persist(PersistAction.UPDATE, msg);
    }
    ...
    public void delete(ActionEvent event) {
        String msg = ResourceBundle.getBundle("bundle/Bundle").getString(itemClass.getSimpleName() + "Deleted");
