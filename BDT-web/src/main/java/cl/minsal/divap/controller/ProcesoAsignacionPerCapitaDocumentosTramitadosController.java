...
@Named("procesoAsignacionPerCapitaDocumentosTramitadosController")
@ViewScoped
public class ProcesoAsignacionPerCapitaDocumentosTramitadosController extends AbstractTaskMBean
