...
@Named ("procesoModificacionDistRecFinProgSubirPlanillasControllerLey" ) 
@ViewScoped 
public class ProcesoModificacionDistRecFinProgSubirPlanillasLey extends AbstractTaskMBean implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7591167983745819463L;
