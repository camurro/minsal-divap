...
@Named ( "procesoModificacionDistRecFinSeguimientoDocumentacionController" ) 
@ViewScoped 
public class ProcesoModificacionDistRecFinSeguimientoDocumentacionController extends AbstractTaskMBean implements Serializable {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = -5061540955808825148L;
