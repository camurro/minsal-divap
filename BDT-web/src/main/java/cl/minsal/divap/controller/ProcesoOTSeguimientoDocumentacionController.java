...
@Named ( "procesoOTSeguimientoDocumentacionController" ) 
@ViewScoped 
public class ProcesoOTSeguimientoDocumentacionController extends AbstractTaskMBean implements Serializable {
